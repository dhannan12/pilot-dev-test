    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-slate-600">Chef's special recommendations highlighted below</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredItems.map(item => (
            ...
            >
              ...
              {item.isChefRecommendation && (
                <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-4 py-2 font-bold text-center text-sm tracking-wide">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-lg font-bold ${
                    item.isChefRecommendation ? 'text-amber-700' : 'text-slate-900'
                  }`}>
